            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" method="post"  enctype="multipart/form-data" action="{{route('porteur.update',$porteurs->id)}}">
                            {{csrf_field()}}
                            ...
                            <div class="box-body">
                                <div class="form-group"   >
                                    ...
                                    <input type="text" name="statut" class="form-control" value="{{$porteurs->statut}}" >
